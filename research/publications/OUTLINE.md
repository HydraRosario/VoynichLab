...
Evidence rule: every future statement must remain within the boundaries defined in `research/publications/CLAIMS.md`.
...
- Refer to `labs/grammar-discovery/docs/ATOMS-V1-SPECIFICATION.md`.
...
Derive this section from `labs/grammar-discovery/docs/LIMITATIONS.md`.
