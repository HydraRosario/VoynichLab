...
const atomsDir = path.join(root, "labs", "eva-comparison", "artifacts", "visual-snapshots", "current", "atoms");
const snapshotManifestPath = path.join(root, "labs", "eva-comparison", "artifacts", "visual-snapshots", "current", "visual-snapshots.tsv");
...
for (const row of manifestRows) {
  ...
  const filePath = path.join(root, "labs", "eva-comparison", "artifacts", "visual-snapshots", "current", row.svg_path.replace(/\\/g, path.sep));
