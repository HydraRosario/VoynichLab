...
function printHelp() {
  console.log(`Usage:
  node labs/eva-comparison/scripts/particle-geometry-order-audit.js --images page-003.jpg,page-004.jpg --out-dir research/audits/particle-geometry-order-current
