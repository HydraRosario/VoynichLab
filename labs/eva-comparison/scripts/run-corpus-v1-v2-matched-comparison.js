...
const outputDir = path.join(repoRoot, "research", "artifacts", "public", "corpus-v1-v2-matched-comparison");
...
writeJson(path.join(outputDir, "manifest.json"), {
  ...
  reportPath: "research/artifacts/public/corpus-v1-v2-matched-comparison/report.md",
  sourceScript: "labs/eva-comparison/scripts/run-corpus-v1-v2-matched-comparison.js",
});
...
\`node labs/eva-comparison/scripts/run-corpus-v1-v2-matched-comparison.js\`
...
const provenance = {
  ...
  sourceScript: "labs/eva-comparison/scripts/run-corpus-v1-v2-matched-comparison.js",
  command: "node labs/eva-comparison/scripts/run-corpus-v1-v2-matched-comparison.js",
  inputs: [
    { path: relative(v1Db), sha256: sha256(v1Db) },
    { path: relative(v2Atoms), sha256: sha256(v2Atoms) },
    { path: "labs/eva-comparison/scripts/export-datasetcreator-atoms.js", sha256: sha256(path.join(labRoot, "scripts", "export-datasetcreator-atoms.js")) },
    { path: "labs/eva-comparison/scripts/role-entropy.js", sha256: sha256(path.join(labRoot, "scripts", "role-entropy.js")) },
  ],
  scope: { folios, pages },
};
