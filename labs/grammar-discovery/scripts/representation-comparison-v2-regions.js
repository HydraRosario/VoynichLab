...
function renderReport() {
  ...
  lines.push("- EVA source tokens: `labs/eva-comparison/cases/<folio>-full/eva-tokens.tsv`.");
  lines.push("- ATOMS source units: `labs/eva-comparison/cases/<folio>-full/atoms.tsv`.");
  lines.push("");
